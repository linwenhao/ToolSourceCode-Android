...
import com.linwh.helper.R;
import com.linwh.helper.tools.DisplayUtil;
...
public class TickView extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mConfig.setUnCheckBaseColor(typedArray.getColor(R.styleable.TickView_uncheck_base_color, getResources().getColor(R.color.tick_gray)))
                ...
                .setTickRadiusOffset(typedArray.getDimensionPixelOffset(R.styleable.TickView_tick_radius_offset, dp2px(4)));
